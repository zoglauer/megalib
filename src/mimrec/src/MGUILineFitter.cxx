...
MGUILineFitter::MGUILineFitter(const TGWindow* p, const TGWindow* main, MSettingsMimrec* Data, bool& OkPressed)
...
void MGUILineFitter::Create()
{
  ...
  */
  ...
  m_Range = new MGUIEMinMaxEntry(this, "Energy fitting range:", false, 470, 530, false, 0);
  AddFrame(m_Range, SectionLayout);
  ...
  MString Comment;
  Comment += "Some comments on the line fit:\n";
  Comment += "1. If you are fitting a line, the FWHM uncertainty is only reliable if the fit is OK. If the fit is not good, you will have an additional systematic uncertainty which is not included in the FWHM uncertainty.";
...
bool MGUILineFitter::ProcessMessage(long Message, long Parameter1,
                                        long Parameter2)
{
