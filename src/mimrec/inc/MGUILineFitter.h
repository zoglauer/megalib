...
#ifndef __MGUILineFitter__
#define __MGUILineFitter__
...
class MGUILineFitter : public MGUIDialog
{
  // Public Interface:
 public:
  //! Standard constructor
  MGUILineFitter(const TGWindow* Parent, const TGWindow* Main, MSettingsMimrec* Data, bool& OkPressed);
  //! Default destructor
  virtual ~MGUILineFitter();
...
#ifdef ___CLING___
 public:
  ClassDef(MGUILineFitter, 0) // Dialogbox: Select the ARM-parameters
#endif
