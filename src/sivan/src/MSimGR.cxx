...
bool MSimGR::ParseBinary(MBinaryStore& Store, const int BinaryPrecision, const int Version)
{
...
bool MSimGR::ToBinary(MBinaryStore& Out, const int WhatToStore, const int BinaryPrecision, const int Version)
{
