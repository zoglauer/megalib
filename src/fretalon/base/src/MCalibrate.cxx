...
//! Default constructor
MCalibrate::MCalibrate() : m_DiagnosticsMode(false), m_RangeMinimum(0), m_RangeMaximum(1000)
{
}
...
TH1D* MCalibrate::CreateHistogramCountsBinned(MReadOutDataGroup& G, double Min, double Max, int Counts, double MinBinWidth)
{
