...
bool MGUIMelinatorMain::OnLoadLast()
{
  ...
  FileName = m_Settings->GetCalibrationFile1();
  Isotopes.clear();
  IsotopeName = m_Settings->GetCalibrationFile1Isotope1();
  if (IsotopeName != "None") {
  ...
  IsotopeName = m_Settings->GetCalibrationFile1Isotope2();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile1Isotope3();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  FileName = m_Settings->GetCalibrationFile2();
  Isotopes.clear();
  IsotopeName = m_Settings->GetCalibrationFile2Isotope1();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile2Isotope2();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile2Isotope3();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  FileName = m_Settings->GetCalibrationFile3();
  Isotopes.clear();
  IsotopeName = m_Settings->GetCalibrationFile3Isotope1();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile3Isotope2();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile3Isotope3();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  FileName = m_Settings->GetCalibrationFile4();
  Isotopes.clear();
  IsotopeName = m_Settings->GetCalibrationFile4Isotope1();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile4Isotope2();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile4Isotope3();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  FileName = m_Settings->GetCalibrationFile5();
  Isotopes.clear();
  IsotopeName = m_Settings->GetCalibrationFile5Isotope1();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile5Isotope2();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
  ...
  IsotopeName = m_Settings->GetCalibrationFile5Isotope3();
  if (IsotopeName != "None") {
    if (Store.Contains(IsotopeName) == false) {
      merr<<"Unable to find isotope: "<<IsotopeName<<show;
      return false;
