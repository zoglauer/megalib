...
/*    AddSubTitle("Options for external input");
    TGLayoutHints* SubLabel = new TGLayoutHints(kLHintsLeft | kLHintsTop, 20, 20, 20, 5);
    TGLabel* ComptonLabel = new TGLabel(this, "Compton options: where2");
    AddFrame(ComptonLabel, SubLabel);

    TGLayoutHints* SubOptions = new TGLayoutHints(kLHintsLeft | kLHintsTop | kLHintsExpandX, 40, 20, 0, 5);
    TGLabel* GeneralLabel = new TGLabel(this, "General options: whereisthisprinted?");
    AddFrame(GeneralLabel, SubLabel);

    m_FileSelector =
      new MGUIEFileSelector(this, "File containing the event type data:",
                            m_Data->GetEventTypeFileName());//To be implemented
    m_FileSelector->SetFileType("file to be implemented", "*.dodo");// implementation in progress
...
//     }
    ...
    m_SigmaHitPos = new MGUIEEntry(this,
                                  ...
                                  false,
                                  m_Data->GetSigmaHitPos(), true, 0.00693);
    AddFrame(m_SigmaHitPos, SubOptions);
