...
#ifndef __MGUIOptionsEventType__
#define __MGUIOptionsEventType__
...
class MGUIOptionsEventType : public MGUIDialog
{
  // Public Interface:
 public:
  MGUIOptionsEventType(const TGWindow* Parent, const TGWindow* Main,
                      MSettingsEventReconstruction* Data,
                      MDGeometryQuest* Geometry);
  virtual ~MGUIOptionsEventType();
...
#ifdef ___CLING___
 public:
  ClassDef(MGUIOptionsEventType, 0)
#endif
