/*
 * MResponseTrackWithinCrossStripDetectorTMVAEventFile.h
 *
...
#ifndef __MResponseTrackWithinCrossStripDetectorTMVAEventFile__
#define __MResponseTrackWithinCrossStripDetectorTMVAEventFile__
...
class MResponseTrackWithinCrossStripDetectorTMVAEventFile : public MResponseMultipleComptonEventFile
{
  // public interface:
 public:
  //! Default constructor
  ...
  //! Default destructor
  virtual ~MResponseTrackWithinCrossStripDetectorTMVAEventFile();
 ...
 protected:
  ...
  vector<vector<MERTrackWithinCrossStripDetectorTMVADataSet*>> m_DataSets;
...
#ifdef ___CLING___
 public:
  ClassDef(MResponseTrackWithinCrossStripDetectorTMVAEventFile, 0) // no description
#endif
