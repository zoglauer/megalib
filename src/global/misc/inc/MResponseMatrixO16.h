...
#ifndef __MResponseMatrixO16__
#define __MResponseMatrixO16__
...
class MResponseMatrixO16 : public MResponseMatrixOx
{
  // public interface:
 public:
  MResponseMatrixO16();
  MResponseMatrixO16(vector<float> x1Dim, vector<float> x2Dim, 
  ...
  MResponseMatrixO16(MString Name, 
                     ...
                     vector<float> x13Dim, vector<float> x14Dim, 
                     vector<float> x15Dim, vector<float> x16Dim);
  virtual ~MResponseMatrixO16();

  void Init();

  bool operator==(const MResponseMatrixO16& R);  
  MResponseMatrixO16& operator+=(const MResponseMatrixO16& R);  
  MResponseMatrixO16& operator-=(const MResponseMatrixO16& R);  
  MResponseMatrixO16& operator/=(const MResponseMatrixO16& R);  

  MResponseMatrixO16& operator+=(const float& Value);  
  MResponseMatrixO16& operator*=(const float& Value);  
  ...
  MString GetAxisName(unsigned int order = 16) const;
  ...
  void SetBinContent(unsigned int x1, unsigned int x2, unsigned int x3, 
                     ...
                     unsigned int x16, float Value = 1);
  ...
  virtual unsigned int GetAxisBins(unsigned int order = 16) const;
  virtual float GetAxisBinCenter(unsigned int b, unsigned int order = 16) const;
  virtual unsigned int GetAxisBin(float v, unsigned int order = 16) const;
  virtual float GetAxisMinimum(unsigned int order = 16) const;
  virtual float GetAxisMaximum(unsigned int order = 16) const;
  virtual float GetAxisLowEdge(unsigned int b, unsigned int order = 16) const;
  virtual float GetAxisHighEdge(unsigned int b, unsigned int order = 16) const;
  ...
  virtual float Get(float x1, float x2, float x3, float x4, 
                    float x5, float x6, float x7, float x8, 
                    float x9, float x10, float x11, float x12, 
                    float x13, float x14, float x15, float x16) const;
 ...
 protected:
  ...
  // private members:
 private:
  MString m_NameAxisO16;
  vector<float> m_AxisO16;
  vector<MResponseMatrixO15> m_AxesO15;
  

  friend ostream& operator<<(ostream& os, const MResponseMatrixO16& R);


#ifdef ___CLING___
 public:
  ClassDef(MResponseMatrixO16, 1) // response matrix of order 16
#endif
