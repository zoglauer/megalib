...
double MResponseMatrixO7::GetSum() const
{
                                     ...
                                     const int Version)
{
  ...
  if (Type == "ResponseMatrixO7") {
    merr<<"MResponseMatrixO7: Non-stream reading is not supported!"<<endl;
    /*
...
bool MResponseMatrixO7::Write(MString FileName, bool Stream)
{
  ...
  if (Stream == false) {
    merr<<"MResponseMatrixO7: Non-stream writing is not supported!"<<endl;
    /*
