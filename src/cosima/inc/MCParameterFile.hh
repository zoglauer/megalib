...
public:
  ...
  /// Return the selected interaction process
  int GetSelectedInteractionProcess() const { return m_SelectedInteractionProcess; }
...
private:
  ...
  /// Selected Interaction Process (-1 = None), otherwise only that one is simulated
  int m_SelectedInteractionProcess;
