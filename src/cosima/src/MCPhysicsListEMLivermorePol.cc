/*
 * MCPhysicsListEMLivermorePol.cxx
 *
 *
 ...
 */
MCPhysicsListEMLivermorePol::MCPhysicsListEMLivermorePol(bool ActivateFluorescence) :
  G4VPhysicsConstructor("LivermorePol"), m_ActivateFluorescence(ActivateFluorescence)
{
 ...
 */
MCPhysicsListEMLivermorePol::~MCPhysicsListEMLivermorePol()
{
  // Intentionally left blank
}
 ...
 */
void MCPhysicsListEMLivermorePol::ConstructParticle()
{
  // Intentionally left blank
}
 ...
 */
void MCPhysicsListEMLivermorePol::ConstructProcess()
{
  ...
  while ((*theParticleIterator)()) {
    ...
    if (ParticleName == "gamma") {
      ...
      // Use standard as long as there is a bug in the polarized version
      ...
      //Manager->
      //  AddDiscreteProcess(new G4LowEnergyPolarizedGammaConversion());
    } 
    // electrons
...
/*
 * MCPhysicsListEMLivermorePol.cc: the end...
 ******************************************************************************/
