...
# docker build -t megalib-3.06 - < Dockerfile
...
# Setup MEGAlib
RUN cd /home/mrmegalib && git clone https://github.com/zoglauer/megalib.git MEGAlib && cd /home/mrmegalib/MEGAlib && /bin/bash setup.sh --ex=/opt/MEGAlib  --branch=MEGAlib_v3.06 --clean=yes
