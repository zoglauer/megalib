...
class GeDSSDElectronTracking:
  ...
  def __init__(self, FileName, OutputPrefix, Layout, MaximumEvents):
  ...
  def test(self):
    ...
    HistDistance = ROOT.TH1F("Distance", "Distance (" + Pattern + ")", 50, 0, 0.5)
    HistDistance.SetLineColor(ROOT.kGreen)
    HistDistance.SetXTitle("Distance in cm")
    HistDistance.SetYTitle("counts")
    HistDirection = ROOT.TH1F("Direction", "Direction (" + Pattern + ")", 180, -180, 180)
